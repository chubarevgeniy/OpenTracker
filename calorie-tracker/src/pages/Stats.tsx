    ...
    <div className="p-4 space-y-6 bg-gray-50 dark:bg-gray-900 min-h-screen pb-24">
      ...
      <div className="bg-gradient-to-br from-purple-600 to-indigo-700 text-white p-5 rounded-2xl shadow-md">
        <div className="flex justify-between items-start mb-4">
          ...
          >
            <option value="30" className="text-gray-900 dark:text-gray-100">Last 30 Days</option>
            <option value="60" className="text-gray-900 dark:text-gray-100">Last 60 Days</option>
            <option value="90" className="text-gray-900 dark:text-gray-100">Last 90 Days</option>
            <option value="all" className="text-gray-900 dark:text-gray-100">All Time</option>
          </select>
        </div>
