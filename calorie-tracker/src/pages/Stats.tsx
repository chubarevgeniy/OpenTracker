...
export default function Stats() {
 ...
 <button
 key={range}
 className={`flex-1 px-2 py-1.5 text-xs rounded-md ${timeRange === range ? 'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 font-medium' : 'text-text-muted hover:bg-bg'}`}
 ...
 {settings.weightGoal && (
 <button
 className={`flex-1 px-2 py-1.5 text-xs rounded-md ${timeRange === 'goal' ? 'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 font-medium' : 'text-text-muted hover:bg-bg'}`}
 ...
 <button
 key={avg}
 className={`px-3 py-1.5 text-xs rounded-md capitalize ${averaging === avg ? 'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 font-medium' : 'text-text-muted hover:bg-bg'}`}
 ...
 <YAxis fontSize={12} />
 <Tooltip contentStyle={{ backgroundColor: 'var(--theme-surface)', color: 'var(--theme-text)', borderColor: 'var(--theme-border)', borderRadius: '8px', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }} itemStyle={{ color: 'var(--theme-text)' }} />
